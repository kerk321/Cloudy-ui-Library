...
Bracket.Instances = {
	...
	Window = function()
		...
		WatermarkLabel.AnchorPoint = Vector2.new(1, 0.5)
		WatermarkLabel.Size = UDim2.new(0, 76, 1, 0)
		WatermarkLabel.BorderColor3 = Color3.fromRGB(0, 0, 0)
		WatermarkLabel.BackgroundTransparency = 1
		WatermarkLabel.Position = UDim2.new(1, -4, 0.5, 0)
		WatermarkLabel.BorderSizePixel = 0
		WatermarkLabel.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		WatermarkLabel.TextStrokeTransparency = 0.75
		WatermarkLabel.TextSize = 12
		WatermarkLabel.TextColor3 = Color3.fromRGB(140, 140, 140)
		WatermarkLabel.Text = ".gg/getcloudy"
		WatermarkLabel.FontFace = Font.fromEnum(Enum.Font.SourceSans)
		WatermarkLabel.TextXAlignment = Enum.TextXAlignment.Right
		WatermarkLabel.Parent = Topbar
...
Bracket.Templates = {
	...
	Window = function(Window)
		...
		local _AutoSize, _AutoPos = Bracket.Utilities.GetAutoWindowSize()
		Window.Position = Bracket.Utilities:GetType(Window.Position, "UDim2", _AutoPos)
		Window.Size = Bracket.Utilities:GetType(Window.Size, "UDim2", _AutoSize)
