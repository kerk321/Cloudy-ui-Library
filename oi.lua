...
local Library do 
    ...
    Library.GetViewportSize = function(self)
    ...
    Library.GetDeviceType = function(self)
        local ViewportSize = self:GetViewportSize()
        if not UserInputService.TouchEnabled then
            return "PC", ViewportSize
        end

        if math.min(ViewportSize.X, ViewportSize.Y) <= 700 then
    ...
    Library.IsCompactLayout = function(self)
        local DeviceType = self:GetDeviceType()
        return DeviceType == "Phone"
    end

    Library.GetWindowMetrics = function(self, RequestedSize)
        local DeviceType, ViewportSize = self:GetDeviceType()
        local Width = RequestedSize and RequestedSize.X.Offset or 563
        local Height = RequestedSize and RequestedSize.Y.Offset or 558
    ...
    Library.IsPointOverFrame = function(self, Frame, Point)
        ...
        Components.Page = function(Data)
            ...
            local Items = { } do 
                Items["Inactive"] = Instances:Create("TextButton", {
                    ...
                    BackgroundTransparency = 1,
                    Name = "\0",
	                Size = UDim2New(0, Metrics.TabButtonWidth, 0, Metrics.TabButtonHeight),
                    BorderSizePixel = 0,
                    TextSize = 12,
                    BackgroundColor3 = FromRGB(255, 255, 255)
            ...
            function Page:Column(ColumnIndex)
                ...
                local Padding = Instances:Create("UIPadding", {
                    ...
                    PaddingTop = UDimNew(0, Metrics.DeviceType == "Phone" and 12 or 18),
                    PaddingBottom = UDimNew(0, Metrics.DeviceType == "Phone" and 12 or 15),
                    PaddingRight = UDimNew(0, Metrics.DeviceType == "Phone" and 12 or 18),
                    PaddingLeft = UDimNew(0, Metrics.DeviceType == "Phone" and 12 or 18)
                }) 

                if Data.Columns and Data.Columns <= 1 then
                    Padding.Instance.PaddingLeft = UDimNew(0, Metrics.DeviceType == "Phone" and 12 or 18)
                    Padding.Instance.PaddingRight = UDimNew(0, Metrics.DeviceType == "Phone" and 12 or 18)
    ...
    Components.Dropdown = function(Data)
        ...
        local Metrics = Library:GetWindowMetrics(Data.WindowSize)
        local RowHeight = Metrics.DropdownHeight
        local OptionHeight = Metrics.DropdownOptionHeight
        local MaxDropdownHeight = Data.MaxSize or Metrics.DropdownMaxSize
        ...
        local Items = { } do
            ...
            Items["Text"] = Instances:Create("TextLabel", {
                ...
                Size = UDim2New(1, 0, 1, 0),
                BorderSizePixel = 0,
                TextSize = Metrics.DeviceType == "Phone" and 13 or 12,
                BackgroundColor3 = FromRGB(255, 255, 255)
            })  Items["Text"]:AddToTheme({TextColor3 = "Text"})
            ...
            Items["RealDropdown"] = Instances:Create("TextButton", {
                ...
                Position = UDim2New(1, 0, 1, 0),
                BorderColor3 = FromRGB(0, 0, 0),
                Size = UDim2New(1, Metrics.DeviceType == "Phone" and -110 or -85, 0, RowHeight),
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(63, 63, 63)
            ...
            Items["Value"] = Instances:Create("TextLabel", {
                ...
                Position = UDim2New(0, 6, 0, Metrics.DeviceType == "Phone" and 0 or -1),
                BackgroundTransparency = 1,
                TextXAlignment = Enum.TextXAlignment.Left,
                BorderSizePixel = 0,
            ...
            Items["OptionHolder"] = Instances:Create("ScrollingFrame", {
                ...
                Active = true,
                AutomaticCanvasSize = Enum.AutomaticSize.Y,
                ScrollBarThickness = Metrics.DeviceType == "Phone" and 4 or 2,
                Size = UDim2New(0, 100, 0, MaxDropdownHeight),
                MidImage = "rbxassetid://85239668542938",
                TopImage = "rbxassetid://85239668542938",
                BottomImage = "rbxassetid://85239668542938",
                Visible = false,
        ...
        local function updateDropdownPosition()
            local AbsolutePosition = Items["RealDropdown"].Instance.AbsolutePosition
            local AbsoluteSize = Items["RealDropdown"].Instance.AbsoluteSize
            Items["OptionHolder"].Instance.Position = UDim2New(0, AbsolutePosition.X, 0, AbsolutePosition.Y + AbsoluteSize.Y + 3)
            Items["OptionHolder"].Instance.Size = UDim2New(0, AbsoluteSize.X, 0, MaxDropdownHeight)
        end
        ...
        Library:Connect(UserInputService.InputBegan, function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                ...
                if Library:IsPointOverFrame(Items["OptionHolder"].Instance, Input.Position) or Library:IsPointOverFrame(Items["RealDropdown"].Instance, Input.Position) then 
                    return
                end
    ...
    Components.Listbox = function(Data)
        ...
        function Listbox:Add(Option)
            ...
            Instances:Create("UIPadding", {
                Parent = OptionButton.Instance,
                PaddingTop = UDimNew(0, Metrics.DeviceType == "Phone" and 4 or 5),
                PaddingLeft = UDimNew(0, 7)
            })
    ...
    Library.Window = function(self, Data)
        ...
        local RequestedSize = Data.Size or Data.size or UDim2New(0, 563, 0, 558)
        local Metrics = Library:GetWindowMetrics(RequestedSize)
        ...
        local Items = Components.Window({
            ...
            Items["Text"] = Instances:Create("TextLabel", {
                ...
                Text = Window.Name,
                Name = "\0",
                Size = UDim2New(0, Metrics.TitleWidth, 0, 24),
                BackgroundTransparency = 1,
                Position = UDim2New(0, Metrics.SidePadding, 0, 14),
                BorderSizePixel = 0,
                RichText = true,
                TextSize = Metrics.DeviceType == "Phone" and 14 or 12,
                TextXAlignment = Enum.TextXAlignment.Left,
            ...
            Items["RealHolder"] = Instances:Create("ScrollingFrame", {
                ...
                ScrollBarImageColor3 = FromRGB(31, 226, 130),
                BackgroundColor3 = FromRGB(255, 255, 255)
            })  Items["RealHolder"]:AddToTheme({ScrollBarImageColor3 = "Accent"})

            local TabList = Instances:Create("UIListLayout", {
                Parent = Items["RealHolder"].Instance,
                VerticalAlignment = Enum.VerticalAlignment.Center,
                FillDirection = Enum.FillDirection.Horizontal,
                Padding = UDimNew(0, Metrics.TabGap),
                SortOrder = Enum.SortOrder.LayoutOrder
            }) 
            ...
            Library:Connect(TabList.Instance:GetPropertyChangedSignal("AbsoluteContentSize"), function()
                Items["RealHolder"].Instance.CanvasSize = UDim2New(0, TabList.Instance.AbsoluteContentSize.X + 4, 0, 0)
            end)

            Items["Content"] = Instances:Create("Frame", {
                Parent = Items["Inline"].Instance,
                Name = "\0",
                Position = UDim2New(0, Metrics.SidePadding, 0, Metrics.ContentTop),
                BorderColor3 = FromRGB(0, 0, 0),
                Size = UDim2New(1, -(Metrics.SidePadding * 2), 1, -Metrics.ContentBottom),
                BorderSizePixel = 2,
                BackgroundColor3 = FromRGB(12, 12, 12)
            })  Items["Content"]:AddToTheme({BackgroundColor3 = "Inline", BorderColor3 = "Outline"})
    ...
    Library.Page = function(self, Data)
        ...
        local RequestedColumns = Data.Columns or Data.columns or 2
        local Metrics = Library:GetWindowMetrics(self.Size)

        local Page = {
            Window = self,

            Name = Data.Name or Data.name or "Page",
            Columns = Metrics.DeviceType == "Phone" and 1 or RequestedColumns,
    ...
    Library.Sections.Dropdown = function(self, Data)
        ...
        local Dropdown = {
            ...
            Callback = Data.Callback or Data.callback or function() end,
            Tooltip = Data.Tooltip or Data.tooltip or nil,
            MaxSize = Data.MaxSize or Data.maxsize or (Library:IsCompactLayout() and 164 or 120),
        ...
        local NewDropdown, Items = Components.Dropdown({
            ...
            WindowSize = Dropdown.Window.Size
        })
